...
export default function LogicPanel() {
  ...
  const handleAddRule = () => {
    const newRule: FormRule = {
      ...
      conditionLogic: 'AND',
      conditions: [{ id: crypto.randomUUID(), type: 'condition', field: '', operator: 'EQUALS', value: '' }],
    ...
    >
      <div className="flex items-center justify-between mb-3">
        ...
        <div className="flex gap-2">
          <button
            onClick={() => onUpdate([...conditions, { id: crypto.randomUUID(), type: 'condition', field: '', operator: 'EQUALS', value: '' }])}
          ...
          <button
            onClick={() => onUpdate([...conditions, { type: 'group', id: crypto.randomUUID(), logic: 'AND', conditions: [{ id: crypto.randomUUID(), type: 'condition', field: '', operator: 'EQUALS', value: '' }] }])}
            className="p-1 rounded-md hover:bg-black/5 dark:hover:bg-white/5 transition-colors text-[10px] font-bold uppercase tracking-wider flex items-center gap-1"
