...
import { FORMS, SUBMISSIONS, AI } from '@/utils/apiConstants';
...
/**
 * Generates frontend integration code using AI.
 * Calls POST /api/v1/ai/generate-integration.
 */
export const generateIntegration = async (framework: string, schema: any) => {
  const response = await fetch(AI.GENERATE_INTEGRATION, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({
      framework,
