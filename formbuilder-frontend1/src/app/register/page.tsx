                ...
                <form onSubmit={handleRegister} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                            <label className="block text-sm font-semibold ml-1" style={{ color: 'var(--text-secondary)' }}>First Name</label>
                            <input
                                type="text"
                                value={firstName}
                        ...
                        <div className="space-y-1.5">
                            <label className="block text-sm font-semibold ml-1" style={{ color: 'var(--text-secondary)' }}>Last Name</label>
                            <input
                                type="text"
                                value={lastName}
                    ...
                    <div className="space-y-1.5">
                        <label className="block text-sm font-semibold ml-1" style={{ color: 'var(--text-secondary)' }}>Email</label>
                        <input
                            type="email"
                            value={email}
