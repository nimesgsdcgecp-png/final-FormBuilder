 ...
 * 
 * Handles interaction with AI models using the generic Spring AI ChatModel
 * interface.
 */
@Service
@Slf4j
...
public class AiArchitectService {
    ...
    private static final String SYSTEM_PROMPT = """
            ...
            ### TARGET JSON STRUCTURE (FormSchema):
            {
              ...
              "formValidations": [
                 { "id": "uuid", "scope": "FIELD", "fieldKey": "f1", "expression": "f1 > 0", "errorMessage": "Must be positive", "executionOrder": 0 }
              ]
            }
    ...
    private String cleanJsonResponse(String raw) {
        ...
        if (processed.contains("```json")) {
            ...
            if (end > start)
                return processed.substring(start, end).trim();
        }
